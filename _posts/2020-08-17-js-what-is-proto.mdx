...
excerpt: "在 JavaScript 內物件可以透過 prototype 自己定義方法，而物件 new 出來的實體要使用這些方法，就需要透過原型鏈 ( `__proto__` ) 來找到上層 prototype 內定義的屬性。"
---
在 JavaScript 內物件可以透過 prototype 自己定義方法，而物件 new 出來的實體要使用這些方法，就需要透過原型鏈 ( `__proto__` ) 來找到上層 prototype 內定義的屬性。
